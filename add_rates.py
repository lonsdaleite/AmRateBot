...
def add_const_rates(all_rates=None):
    ...
    add_rate(all_rates, "usd", "bank", "ru", "raif",       "usd", "bank", "am", "",         "swift",    1.03,  "from")
    add_rate(all_rates, "eur", "bank", "ru", "raif",       "eur", "bank", "am", "",         "swift",    1.03,  "from")
    add_rate(all_rates, "rur", "bank", "am", "yunibank",   "rur", "cash", "am", "",         "yunibank", 1.02,  "from")
    add_rate(all_rates, "usd", "bank", "am", "yunibank",   "usd", "cash", "am", "",         "yunibank", 1.02,  "from")
    add_rate(all_rates, "eur", "bank", "am", "yunibank",   "eur", "cash", "am", "",         "yunibank", 1.02,  "from")
    add_rate(all_rates, "amd", "bank", "am", "yunibank",   "amd", "cash", "am", "",         "atm",      1,     "from")
    add_rate(all_rates, "amd", "cash", "am", "",           "amd", "bank", "am", "yunibank", "yunibank", 1,     "from")
    add_rate(all_rates, "usd", "cash", "am", "",           "usd", "bank", "am", "yunibank", "yunibank", 1,     "from")
    add_rate(all_rates, "eur", "cash", "am", "",           "eur", "bank", "am", "yunibank", "yunibank", 1,     "from")
    add_rate(all_rates, "rur", "cash", "am", "",           "rur", "bank", "am", "yunibank", "yunibank", 1.02,  "from")
